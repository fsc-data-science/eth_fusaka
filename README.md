...
1. **Rename `content-template.html`** to your analysis name (e.g., `aerodrome-rise.html`)
...
See the main [TRACE website repository](https://github.com/username/TRACE) for integration details and website structure.
